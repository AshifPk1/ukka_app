...

{
    ...
    'depends': [
        'contacts','sale','odx_delivery_customization'
    ],
    'data': [
        'security/ir.model.access.csv',
        'data/whatsapp_error_log_cron.xml',
        'templates/product_data_template.xml',
        'templates/picking_data_template.xml',
        ...
        'wizard/whatsapp_message_customer_view.xml',
        'wizard/whatsapp_message_vendor_view.xml'
    ],
